...
successCount = 1
emptyCount = 1
with open('data/trainingdata.yml', encoding='utf-8', mode='w') as f:
    f.write("categories:\r\n")
    f.write("- Conversations")
    f.write("\r\nconversations:")
    with open('data/chatbot.csv', encoding='utf-8', errors='ignore') as g:
        lines = csv.reader(g)
        for line in lines:
            lineCount += 1
...
print("==============================================")
print("I have successfully imported " + str(successCount - 1) + " rows of info and will now retrain...")
print("==============================================")
