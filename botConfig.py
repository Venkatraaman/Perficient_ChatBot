...
myBotName = "Perficient ChatBot"
botTimeZone = "America/New_York"  ##See the list full below
botAvatar = "/static/bot1.png" ##This can either be an image in your static folder or a web url to an image
...
confidenceLevel = 0.90 ##Bot confidence level - must be betwee. 0.00 and 1, default is 0.65
